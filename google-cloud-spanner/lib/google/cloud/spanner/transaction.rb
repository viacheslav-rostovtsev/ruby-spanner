  ...
  module Cloud
    module Spanner
      ...
      class Transaction
        ...
        # The `Spanner::Session` session for this txn.
        ...
        # Whether to exclude from change streams.
        # @return [::Boolean]
        # @private
        ...
        # The underlying `V1::Service` grpc service object
        # @return [::Google::Cloud::Spanner::V1::Service]
        def service
          session.service
        end
      end
